...
var app = (function () {
    ...
    /* src/6.InputBinding.svelte generated by Svelte v3.24.1 */

    const file = "src/6.InputBinding.svelte";
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<_6_InputBinding> was created with unknown prop '${key}'`);
    	});
